...
class Transfer extends Component {
  constructor(props) {
    ...
    let [
      availableColumns,
      displayColumns
    ] = this.buildAvailableAndDisplayColumns(props);
  ...
  initState(props, availableColumns, displayColumns) {
    ...
    let saveAvailable = this.isColumnsChanged(
      ...availableColumns,
      ...displayColumns
    );
  ...
  transferSelectedItems(givenList, recivedList) {
    let { true: selectedColumns, false: unSelectedColumns } = groupBy(
      givenList,
      "selected"
    );
  ...
  addToDisplay = () => {
    let { availableColumns, displayColumns } = this.state;
    this.updateState(
      ...this.transferSelectedItems(availableColumns, displayColumns)
    );
  };
  ...
  onCancel = () => {
    ...
    availableColumns = mapFromAnotherBy(
      this.originalAvailableColumns,
      allColumns,
      "tid"
    );
    displayColumns = mapFromAnotherBy(
      this.originalDisplayColumns,
      allColumns,
      "tid"
    );
      ...
      <div className="transfer">
        <div className="transfer-core">
          ...
          <FeatureList
            ...
            checkbox={this.props.showCheckbox}
          />
        </div>
        {cancelAndSave && (
